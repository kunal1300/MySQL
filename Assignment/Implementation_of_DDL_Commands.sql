...
alter table Products add column Description int;

describe Products;

-- Step 2: Modify the Data Type of a Column

alter table Products modify column Description varchar(50);
...
update products set ProductName = "laptop" where Category = 101;
